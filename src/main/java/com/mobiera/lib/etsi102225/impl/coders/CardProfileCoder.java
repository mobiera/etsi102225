...
import com.mobiera.lib.etsi102225.api.model.SPI;
...
public class CardProfileCoder
{
	...
	public static CardProfile encode(byte[] datarow) throws CodingException
	{
		...
		newCardProfile.setSecurityBytesType(SecurityBytesType.WITH_LENGHTS);
		...
		switch (kid.getAlgorithmImplementation())
		{
			...
			case AES:
				...
				{
					case AES_CMAC4:
						newCardProfile.setSignatureAlgorithm(SignatureManager.AES_CMAC4);
						break;

					case AES_CMAC8:
						newCardProfile.setSignatureAlgorithm(SignatureManager.AES_CMAC8);
						break;
